    ...
    <div className="flex h-full items-center justify-center bg-bg px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-lg border border-border bg-surface p-6 shadow-sm">
          <h1 className="mb-1 text-base font-medium text-text">Create an account</h1>
          <p className="mb-5 text-xs text-text-subtle">Start managing your Postgres projects.</p>
